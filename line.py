...
# TODO: Need to break down variables into class attributes for Left & Right
# TODO: Can this be broken in half?  Shortened?
def find_lines(left, right, binary_warped, image):
    if left.detected == False | right.detected == False:
        # Assuming you have created a warped binary image called "binary_warped"
        # Take a histogram of the bottom half of the image
        sh = int(binary_warped.shape[0]/2)
        histogram = np.sum(binary_warped[sh:,:], axis=0)
